...
HD_PWD='/run/media/atharva/nux/ece540_rvfpga_sources/Labs/Proj_4_ImageProcessing/project_4_image_processing/project_4_image_processing.runs/clk_vga_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_vga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_vga.tcl
