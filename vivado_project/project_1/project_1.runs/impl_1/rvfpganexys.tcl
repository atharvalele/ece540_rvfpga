...
set rc [catch {
  ...
  set_property webtalk.parent_dir /run/media/atharva/nux/ece540_rvfpga_sources/vivado_project/project_1/project_1.cache/wt [current_project]
  set_property parent.project_path /run/media/atharva/nux/ece540_rvfpga_sources/vivado_project/project_1/project_1.xpr [current_project]
  set_property ip_output_repo /run/media/atharva/nux/ece540_rvfpga_sources/vivado_project/project_1/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet /run/media/atharva/nux/ece540_rvfpga_sources/vivado_project/project_1/project_1.runs/synth_1/rvfpganexys.dcp
