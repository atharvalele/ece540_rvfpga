...
#ifndef VERILATED_VRVFPGASIM_DPRAM64__S10000_MBZ1_H_
#define VERILATED_VRVFPGASIM_DPRAM64__S10000_MBZ1_H_  // guard
...
VL_MODULE(Vrvfpgasim_dpram64__S10000_MBz1) {
  public:
    ...
    // CONSTRUCTORS
    Vrvfpgasim_dpram64__S10000_MBz1(const char* name);
    ~Vrvfpgasim_dpram64__S10000_MBz1();
    VL_UNCOPYABLE(Vrvfpgasim_dpram64__S10000_MBz1);
