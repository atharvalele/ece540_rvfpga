...
VL_INLINE_OPT void Vrvfpgasim_dpram64__S1000_MBz1___sequent__TOP__rvfpgasim__swervolf__bootrom__ram__1(Vrvfpgasim_dpram64__S1000_MBz1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrvfpgasim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vrvfpgasim_dpram64__S1000_MBz1___sequent__TOP__rvfpgasim__swervolf__bootrom__ram__1\n"); );
    // Init
